  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background hover:bg-primary-light hover:text-primary hover:border-primary shadow-card",
        secondary:
        ...
        hero: "hero-gradient text-primary-foreground hover:shadow-hero transform hover:-translate-y-0.5 font-medium",
        accent: "accent-gradient text-accent-foreground hover:shadow-elevated transform hover:-translate-y-0.5 font-medium",
